...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_POST['action'])) {
  ...
  header("Location: pages/admin/transactions.php?msg=" . urlencode($flash));
  exit;
}
...
<main class="main">
  ...
  <section class="card" style="background:var(--accent-mid);">
    ...
    <form method="get" style="display:flex;gap:8px;flex-wrap:wrap;align-items:center;margin-bottom:12px;">
      ...
      <a class="btn" href="pages/admin/transactions.php">Reset</a>
    </form>
      ...
      <?php foreach ($rows as $r): ?>
        <div class="table__row" style="grid-template-columns: 1fr .8fr .6fr .7fr .6fr;">
          ...
          <div class="table__right">
            <a class="btn" href="pages/admin/transaction_view.php?id=<?php echo (int)$r['id']; ?>">View</a>
